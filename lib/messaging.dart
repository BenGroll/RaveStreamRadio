...
Future sendMessageToTopic(
  ...
  List<String>? userInTopic = await db.getUsersForTopic(topicname);
  if (userInTopic == null) return null;
  return await sync(userInTopic.map((e) {
    return sendMessageToUsername(e, title, content)!;
  }).toList());
}
