              ...
              return ValueListenableBuilder(
                  ...
                  builder: ((context, value, child) {
                    if (event_data!.length >=
                        current_page.value * itemsperpage) {
                      return FutureBuilder(
                          ...
                          builder: ((context, snapshot) {
                            if (snapshot.connectionState !=
                              ...
                              for (int i = (current_page.value) * itemsperpage;
                                  i < (current_page.value + 1) * itemsperpage;
                                  i++) {
        ...
        child: AspectRatio(
            ...
            child: Card(
                ...
                child: InkWell(
                  onTap: () {
                    kIsWeb 
                    ? Beamer.of(context).beamToNamed("/events/${event.eventid}")
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              event.hostreference != null
                                                  ? linkbuttons.UsernameLinkButton(
...
class PageIndicator extends StatelessWidget {
  final int pagecount = (totalelements / itemsperpage).ceil();
